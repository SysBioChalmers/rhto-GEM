function [newEqns, newNames] = makeRxns(templEqn, templName, reduced, comps, chain1, chain2, chain3, chain4)
% makeRxns
...
%   chain1      = {'16:0','18:3'}
%
%   [newEqns newNames] = makeRxns(templEqn,templName,false,comps,chain)
...
compsDB.name      = {'cytoplasm','cell envelope','extracellular',...
    'endoplasmic reticulum','endoplasmic reticulum membrane','Golgi',...
